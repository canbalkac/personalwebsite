			...
			<div className="flex flex-col md:flex-row justify-center items-center gap-20">
				<div className="space-y-5">
					{Contacts.map((contact: any, i: number) => (
						<div
							key={i}
							className="bg-light-mode-card dark:bg-[#222222] py-5 px-10 rounded-lg"
						>
				...
				<div className="bg-light-mode-card dark:bg-[#222222] p-14 rounded-lg">
					<Form {...form}>
						<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
							...
							/>
							<Button
								className="bg-light-mode-bg hover:bg-[#86745a] dark:bg-black dark:hover:bg-neutral-800 dark:text-white"
								type="submit"
							>
								Submit
							</Button>
